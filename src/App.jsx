...
const App = () => {
  ...
  return (
    <div className="bg-black min-h-screen flex items-center justify-center text-white overflow-hidden p-4">
      {/*-----liquid glass sample-----*/}
      <Toaster />
      {syncUser ? (
        <main
          className="container w-[90vw] h-[90vh] relative rounded-2xl backdrop-blur-xl bg-gradient-to-br from-white/10 via-write/5 to-write/10 border border-white/20
